...
class ImageFeedViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageFeedViewHolder(View itemView, Activity activity) {
        super(itemView);
    ...
    public void bindView(FeedItem feedItem) {
        ...
        Glide.with(itemView).load(feedItem.getSource()).apply(RequestOptions.placeholderOf(R.drawable.placeholder_image)).into(ivFeedCenter);
