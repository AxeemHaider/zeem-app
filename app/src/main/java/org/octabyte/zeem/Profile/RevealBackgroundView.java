...
public class RevealBackgroundView extends View {
    ...
    public RevealBackgroundView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RevealBackgroundView);
        try {
            bgColor = typedArray.getString(R.styleable.RevealBackgroundView_bgColor);
        }finally {
            typedArray.recycle();
        }
